...
function isPlainObject(obj: Record<string, any>) {
  if (
    (obj.prototype === null ||
...
function getParsedType(obj: unknown): ParsedType {
...
function getPropertyFromDescriptorEntry([name, descriptor]: [
  string,
...
export function getProperties(obj: unknown, options: Options) {
...
export function parsePrototypes(
  obj: unknown,
